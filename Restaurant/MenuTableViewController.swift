...
class MenuTableViewController: UITableViewController {
    ...
    // instances created to make appropriate network request
    var menuItems = [MenuItem]()
    
    // String property to hold category data
    var category: String!
    
    // Create screen before loading 
...
//
    ...
    // returns the number of rows that need to be created
    ...
    // set menu item text and price to row
    ...
    // prepare the details of the menu item when clicked
